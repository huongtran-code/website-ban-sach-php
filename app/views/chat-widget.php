...
<script>
    ...
    function toggleChatWidget() {
        ...
        if (chatWidgetOpen) {
            ...
            loadChatMessages();
            // Đánh dấu đã đọc
            fetch('../app/controllers/mark-chat-read.php');
            // Auto refresh
    ...
    function checkTypingStatus() {
        fetch('../app/controllers/get-typing-status.php')
    ...
    function loadChatMessages() {
        fetch('../app/controllers/get-chat-messages.php')
            .then(response => response.json())
            .then(data => {
    ...
    function sendChatMessage(e) {
        ...
        fetch('../app/controllers/send-chat-message.php', {
            method: 'POST',
            body: formData
        })
        .then(response => response.json())
    ...
    setInterval(() => {
        if (!chatWidgetOpen) {
            fetch('../app/controllers/get-unread-count.php')
                .then(response => response.json())
                .then(data => {
