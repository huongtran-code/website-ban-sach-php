                            ...
                            <table class="table table-hover mb-0">
                                ...
                                <tbody>
                                    <?php $i = 0; foreach ($books as $book): $i++; ?>
                                        <tr>
                                            <td><?=$i?></td>
                                            <td><img src="uploads/cover/<?=$book['cover']?>" width="50" class="rounded" onerror="this.src='https://via.placeholder.com/50x70'"></td>
                                            ...
                                            <td>
                                                ...
                                                <a href="php/delete-book.php?id=<?=$book['id']?>" class="btn btn-danger btn-sm" onclick="return confirm('Xóa sách này?')" title="Xóa"><i class="fas fa-trash"></i></a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
