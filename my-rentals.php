...
<body>
                ...
                ?>
                    <div class="col-md-6 col-lg-4 mb-4">
                        <div class="card h-100 <?=$is_overdue ? 'border-danger' : ''?>">
                            ...
                            <div class="row g-0">
                                <div class="col-4">
                                    <img src="uploads/cover/<?=$rental['cover']?>" class="img-fluid rounded-start h-100" style="object-fit: cover;" onerror="this.src='https://via.placeholder.com/150x200'">
                                </div>
                                <div class="col-8">
                                    <div class="card-body">
                                        ...
                                        <?php if ($rental['status'] == 'active'): ?>
                                            ...
                                            <div class="d-flex gap-2 mt-2">
                                                ...
                                                ?>
                                                <a href="php/return-rental.php?id=<?=$rental['id']?>" class="btn btn-sm btn-outline-success" onclick="return confirm('<?=addslashes($return_confirm)?>')">
    ...
    function confirmExtend() {
        ...
        if (confirm(msg)) {
            window.location.href = 'php/extend-rental.php?id=' + currentExtendRentalId + '&days=' + days;
        }
    }
    </script>
</body>
