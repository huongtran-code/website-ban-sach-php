...
$books = !empty($key) ? search_books($conn, $key, $sort) : 0;
...
<head>
    ...
    <title>Tìm kiếm: <?=htmlspecialchars($key)?> - Nhà Sách Online</title>
        ...
        <div class="main-content">
            ...
            <section class="books-section">
                <div class="section-header d-flex justify-content-between align-items-center">
                    <div>
                        <h2><i class="fas fa-search"></i> Kết quả: "<?=htmlspecialchars($key)?>"</h2>
                ...
                <?php else: ?>
                    <p class="mb-4">Tìm thấy <strong><?=count($books)?></strong> kết quả</p>
