                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4 text-end">
                        <?php if (!empty($promotion['banner_image'])): ?>
                            <img src="../storage/uploads/banners/<?=$promotion['banner_image']?>" class="img-fluid rounded" style="max-height: 150px;">
                        <?php endif; ?>
                    </div>
                </div>
                            ...
                            <div class="col-6 col-md-4 col-lg-3 mb-4">
                                <div class="card h-100 shadow-sm border-0">
                                    <div class="position-relative">
                                        ...
                                        <img src="../storage/uploads/cover/<?=$book['cover']?>" class="card-img-top" style="height: 200px; object-fit: cover;" onerror="this.src='https://via.placeholder.com/200x250'">
                                    </div>
                                    <div class="card-body">
