                                    ...
                                    <?php foreach ($categories as $cat): ?>
                                        <tr>
                                            ...
                                            <td width="120" class="text-end">
                                                ...
                                                <a href="../app/controllers/delete-category.php?id=<?=$cat['id']?>" class="btn btn-danger btn-sm" onclick="return confirm('Xóa?')" title="Xóa"><i class="fas fa-trash"></i></a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-body p-4">
                                <form action="../app/controllers/add-category.php" method="post">
                                    <div class="mb-3">
