                            ...
                            <?php $i = 0; foreach ($users as $u): $i++; ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php if (empty($u['is_banned'])): ?>
                                            <a href="../app/controllers/toggle-user-ban.php?action=ban&id=<?=$u['id']?>" class="btn btn-outline-danger btn-sm" onclick="return confirm('Khóa tài khoản người dùng này? Họ sẽ không thể đăng nhập.')" title="Khóa tài khoản">
                                                <i class="fas fa-user-slash"></i>
                                            </a>
                                        <?php else: ?>
                                            <a href="../app/controllers/toggle-user-ban.php?action=unban&id=<?=$u['id']?>" class="btn btn-outline-success btn-sm" onclick="return confirm('Mở khóa tài khoản người dùng này?')" title="Mở khóa tài khoản">
                                                <i class="fas fa-unlock"></i>
                                            </a>
                                        <?php endif; ?>
                                        <a href="../app/controllers/delete-user.php?id=<?=$u['id']?>" class="btn btn-danger btn-sm" onclick="return confirm('Xóa người dùng này?')" title="Xóa">
        ...
        <div class="modal fade" id="editMembershipModal<?=$u['id']?>" tabindex="-1">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="../app/controllers/edit-membership.php" method="POST">
                        <div class="modal-body">
