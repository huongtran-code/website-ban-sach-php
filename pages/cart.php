                    ...
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            <?php foreach ($cart_items as $item): ?>
                                <tr>
                                    <td>
                                        <img src="../storage/uploads/cover/<?=$item['cover']?>" width="60" class="rounded" onerror="this.src='https://via.placeholder.com/60x80'">
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <a href="../app/controllers/remove-cart.php?id=<?=$item['book_id']?>" class="btn btn-danger btn-sm">
    ...
    <script>
        ...
        document.querySelectorAll('.quantity-input').forEach(function(input) {
            input.addEventListener('change', function() {
                ...
                fetch('../app/controllers/update-cart.php', {
                    method: 'POST',
                    body: formData
                })
                .then(response => {
