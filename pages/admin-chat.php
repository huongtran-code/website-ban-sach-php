...
include MODELS_PATH . "func-chat.php";
...
<body>
    ...
    <script>
        ...
        function sendMessage(e) {
            ...
            fetch('../app/controllers/send-admin-chat-message.php', {
                method: 'POST',
                body: formData
            })
        ...
        function sendTypingStatus(typing) {
            ...
            fetch('../app/controllers/set-typing-status.php', {
                method: 'POST',
                body: formData
        ...
        function checkTypingStatus() {
            fetch('../app/controllers/get-typing-status.php?user_id=<?=$selected_user_id?>')
                .then(response => response.json())
                .then(data => {
                    if (data.success) {
        ...
        setInterval(() => {
            fetch('../app/controllers/get-admin-chat-messages.php?user_id=<?=$selected_user_id?>')
                .then(response => response.json())
            .then(data => {
        ...
        function searchUsers(keyword) {
            ...
            fetch('../app/controllers/search-users.php?keyword=' + encodeURIComponent(keyword))
                .then(response => response.json())
                .then(data => {
