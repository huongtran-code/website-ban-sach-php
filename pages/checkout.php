...
<body>
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="../app/controllers/process-checkout.php" method="post" id="checkoutForm">
    ...
    <script>
        ...
        function requestDistanceShipping(fullAddress) {
            ...
            fetch('../app/controllers/calc-shipping-distance.php', {
                method: 'POST',
                body: formData
            })
            .then(res => res.json())
    ...
    <script>
        ...
        document.getElementById('applyCouponBtn').addEventListener('click', function() {
            ...
            fetch(`../app/controllers/check-coupon.php?code=${encodeURIComponent(code)}`)
        ...
        if (chooseCouponBtn && couponModal) {
            chooseCouponBtn.addEventListener('click', function() {
                ...
                fetch('../app/controllers/get-available-coupons.php')
                    .then(res => res.json())
                    .then(data => {
