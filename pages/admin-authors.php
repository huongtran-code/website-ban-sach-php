...
<body>
    ...
    <div class="container py-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2><i class="fas fa-user-edit text-warning"></i> Quản lý tác giả</h2>
        </div>
        ...
        <ul class="nav nav-tabs mb-4" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="nav-link <?=$active_tab == 'list' ? 'active' : ''?>" id="list-tab" data-bs-toggle="tab" data-bs-target="#list" type="button" role="tab">
                    <i class="fas fa-list me-1"></i>Danh sách tác giả
                </button>
            </li>
            <li class="nav-item" role="presentation">
            ...
            <div class="tab-pane fade <?=$active_tab == 'list' ? 'show active' : ''?>" id="list" role="tabpanel">
                <div class="card table-card">
                    <div class="card-header bg-warning text-dark d-flex justify-content-between align-items-center">
                        <h5 class="mb-0"><i class="fas fa-user-edit me-2"></i>Danh sách tác giả</h5>
                        <div class="input-group" style="max-width: 250px;">
                            <input type="text" class="form-control form-control-sm" id="searchAuthors" placeholder="Tìm kiếm tác giả...">
                    ...
                    <div class="card-body p-0 scrollable-container-sm">
                        <?php if ($authors == 0): ?>
                            <div class="text-center py-5">
                                ...
                                <p class="text-muted">Chưa có tác giả nào</p>
                            </div>
                        <?php else: ?>
                            <table class="table table-hover mb-0">
                                ...
                                <tbody>
                                    <?php foreach ($authors as $author): ?>
                                        <tr>
                                            <td><i class="fas fa-user-circle text-warning me-2"></i><?=htmlspecialchars($author['name'])?></td>
                                            <td width="120" class="text-end">
                                                <a href="edit-author.php?id=<?=$author['id']?>" class="btn btn-warning btn-sm" title="Sửa"><i class="fas fa-edit"></i></a>
                                                <a href="../app/controllers/delete-author.php?id=<?=$author['id']?>" class="btn btn-danger btn-sm" onclick="return confirm('Xóa?')" title="Xóa"><i class="fas fa-trash"></i></a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-header bg-warning text-dark">
                                <h5 class="mb-0"><i class="fas fa-user-plus me-2"></i>Thêm tác giả mới</h5>
                            </div>
                            <div class="card-body p-4">
                                <form action="../app/controllers/add-author.php" method="post">
                                    <div class="mb-3">
                                        <label class="form-label"><i class="fas fa-user me-1"></i>Tên tác giả</label>
                                    ...
                                    <div class="d-flex gap-2">
                                        <button type="submit" class="btn btn-warning">
                                            <i class="fas fa-save me-1"></i>Lưu tác giả
                                        </button>
    ...
    <script>
        // Tìm kiếm tác giả
        document.getElementById('searchAuthors').addEventListener('input', function() {
