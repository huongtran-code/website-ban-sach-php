...
<body>
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?=$i?></td>
                                            <td>
                                                <img src="../storage/uploads/cover/<?=$book['cover']?>" width="40" height="50" class="me-2" style="object-fit: cover;">
    ...
    <div class="modal fade" id="addTransactionModal" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="../app/controllers/add-transaction.php" method="post">
    ...
    <script>
        ...
        function exportExcel() {
            ...
            let url = `../app/controllers/export-transactions.php?`;
            const params = [];
