                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr class="<?=$is_overdue ? 'table-danger' : ''?> <?=$rental['late_count'] >= $max_late ? 'table-warning' : ''?>">
                                        <td><?=$i + 1?></td>
                                        <td>
                                            <img src="../storage/uploads/cover/<?=$rental['cover']?>" width="40" class="me-2 rounded">
                                        ...
                                        <td>
                                            <?php if ($rental['status'] == 'active'): ?>
                                                <a href="../app/controllers/admin-extend-rental.php?id=<?=$rental['id']?>" class="btn btn-sm btn-outline-primary" onclick="return confirm('Gia hạn thêm 7 ngày?')">
                                                    <i class="fas fa-redo"></i>
                                                </a>
                                                <a href="../app/controllers/admin-return-rental.php?id=<?=$rental['id']?>" class="btn btn-sm btn-outline-success" onclick="return confirm('Xác nhận trả sách?')">
