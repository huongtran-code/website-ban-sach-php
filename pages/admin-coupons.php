...
include MODELS_PATH . "func-coupon.php";
                ...
                <div class="row">
                    <div class="col-lg-5">
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <form action="../app/controllers/add-coupon.php" method="post">
                                    <div class="mb-3">
                                                ...
                                                <?php foreach ($coupons as $c): ?>
                                                    ...
                                                    <td>
                                                        ...
                                                        <td class="text-end">
                                                            ...
                                                            <form action="../app/controllers/toggle-coupon.php" method="post" class="d-inline">
                                                            ...
                                                            <form action="../app/controllers/delete-coupon.php" method="post" class="d-inline" onsubmit="return confirm('Bạn có chắc muốn xóa mã khuyến mãi này?');">
                                                                <input type="hidden" name="id" value="<?=$c['id']?>">
                ...
                <div class="row">
                    <div class="col-lg-5">
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <form action="../app/controllers/add-promotion.php" method="post" enctype="multipart/form-data">
                                    <div class="mb-3">
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td class="text-end">
                                                            ...
                                                            <form action="../app/controllers/toggle-promotion.php" method="post" class="d-inline">
                                                            ...
                                                            <form action="../app/controllers/delete-promotion.php" method="post" class="d-inline" onsubmit="return confirm('Bạn có chắc muốn xóa chương trình này?');">
                                                                <input type="hidden" name="id" value="<?=$promo['id']?>">
                                ...
                                <table class="table table-hover mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                <td>
                                                    <img src="../storage/uploads/cover/<?=$book['cover']?>" alt="<?=htmlspecialchars($book['title'])?>" style="width: 60px; height: 80px; object-fit: cover; border-radius: 4px;" onerror="this.src='https://via.placeholder.com/60x80'">
                                                </td>
                                                <td>
