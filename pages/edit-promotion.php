...
<body>
        ...
        <div class="row">
            <div class="col-lg-5">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="../app/controllers/edit-promotion.php" method="post" enctype="multipart/form-data">
                            ...
                            <?php if (!empty($promotion['banner_image'])): ?>
                                <div class="mb-3">
                                    ...
                                    <img src="../storage/uploads/banners/<?=$promotion['banner_image']?>" class="img-thumbnail" style="max-height: 100px;">
                                </div>
                            <?php endif; ?>
                            <div class="mb-3">
                                ...
                                <table class="table table-hover mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                <td>
                                                    <img src="../storage/uploads/cover/<?=$pb['cover']?>" style="width: 50px; height: 65px; object-fit: cover; border-radius: 4px;" onerror="this.src='https://via.placeholder.com/50x65'">
                                                </td>
                                                ...
                                                <td class="text-end">
                                                    <div class="btn-group" role="group">
                                                        ...
                                                        <form action="../app/controllers/remove-book-from-promotion.php" method="post" class="d-inline" onsubmit="return confirm('Xóa sách này khỏi chương trình?');">
    ...
    <div class="modal fade" id="addBookModal" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="../app/controllers/add-book-to-promotion.php" method="post">
    ...
    <div class="modal fade" id="editDiscountModal" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form id="editDiscountForm" action="../app/controllers/update-book-promotion-discount.php" method="post">
                    <div class="modal-body">
                        <input type="hidden" name="promotion_id" value="<?=$promotion['id']?>">
    ...
    <script>
        ...
        function saveAllDiscounts() {
            ...
            form.method = 'POST';
            form.action = '../app/controllers/update-all-book-discounts.php';
